...
REAL(KIND=r8), DIMENSION(:,:), ALLOCATABLE:: f, m, res, u
!
...
END IF
!
ALLOCATE(u(0:mx(1)+1,0:mx(2)+1),  f(1:mx(1),1:mx(2)), &
         m(0:mx(1)+1,0:mx(2)+1),res(1:mx(1),1:mx(2)))
!
u = 0.0_r8
!
...
!
CALL LinearMultigrid(u,f,m,res,h,tol,iter,energyminimum)
!
CALL PrintOUT
!
DEALLOCATE(u,f,m,res)
!
CONTAINS
!
SUBROUTINE PrintOut
